...
function validate()
{
	...
	var mname = document.cust.mName;
	if(isEmpty(mname)==false)
	{
		if(isAlphabet(mname)==false)
		{
	...
	var login = document.cust.loginId;
	if(isEmpty(login))
	{
...
<form name="cust" action="index.php?sec=AddCust" method="POST" onsubmit="return validate()">
<br />
<br />
<h3 style="left:2%;  position:relative;">
...
<tr>
	...
	<!--<td> <input type="button" name="checkAvail" value="Check Availability" />-->
</tr>
<tr>
	<td> Password :</td>
...
<tr>
	<td><input type="submit" name="SubAddCust" value="Submit" /></td>
